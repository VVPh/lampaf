    ...
    function initLang() {
      ...
      Lampa.Lang.add({
        ...
        online_mod_file_helper: {
          ru: 'Удерживайте клавишу "ДА" для вызова контекстного меню',
        ...
        online_mod_timeclear_all: {
          ru: 'Сбросить временные метки у всех',
        ...
        online_mod_collaps_lampa_player: {
          ru: 'Collaps: Встроенный проигрыватель',
        ...
        online_mod_save_last_balanser: {
          ru: 'Сохранять историю источников',
          uk: 'Зберігати історію источників',
          be: 'Захоўваць гісторыю балансараў',
          en: 'Save history of balancers',
          zh: '保存平衡器的历史记录'
        },
        online_mod_clear_last_balanser: {
          ru: 'Очистить историю источников',
          uk: 'Очистити історію источників',
        ...
        online_mod_rezka2_fix_stream: {
          ru: 'Исправление видеопотока для HDrezka',
