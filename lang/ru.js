export default {
    ...
    settings_cub_sync_descr: 'Синхронизация с сервисом CUB: синхронизация ваших закладок, истории просмотров, меток и временных кодов. Сайт: www.cub.red',
    ...
    settings_cub_sync_timecodes: 'Синхронизация временных кодов',
    ...
    settings_interface_card_poster: 'Показать афишу',
    ...
    settings_main_player: 'Проигрыватель',
    ...
    settings_rest_tmdb_posters: 'Разрешение афиш TMDB',
    ...
    settings_rest_screensaver_time: 'Через сколько минут запустить заставку',
    ...
    settings_rest_cache_images_descr: 'Кэшировать афишы и фоны в локальное хранилище',
    ...
    settings_parser_use_descr: 'Тем самым, вы соглашаетесь принять на себя всю ответственность за использование публичных ссылок для просмотра торрентов и прочего.',
    ...
    settings_player_type_descr: 'Каким проигрывателем воспроизводить видео',
    settings_player_iptv_type: 'Тип проигрывателя для IPTV',
    settings_player_iptv_type_descr: 'Каким проигрывателем воспроизводить IPTV-каналы',
    settings_player_torrent_type: 'Тип проигрывателя для торрентов',
    settings_player_torrent_type_descr: 'Каким проигрывателем воспроизводить торренты',
    settings_player_reset: 'Сбросить проигрыватель по умолчанию',
    settings_player_reset_descr: 'Сбрасывает выбранный Android-проигрыватель в приложении',
    settings_player_path: 'Путь к проигрывателю',
    settings_player_path_descr: 'Укажите путь к исполняемому файлу проигрывателя',
    ...
    settings_player_timecode: 'Временной код',
    ...
    settings_player_launch_trailers: 'Проигрыватель для видеороликов',
    ...
    torrent_install_text: 'TorrServer – приложение, которое позволяет просматривать содержание из торрент-файлов.<br><br>Более детальную информацию по установке вы найдете в Telegram-группах, указанных ниже.',
    ...
    title_new: 'Новинки',
    title_trend_day: 'Популярное сегодня',
    title_trend_week: 'Популярное за неделю',
    title_upcoming: 'Смотрите в кинозалах',
    title_top_movie: 'Лучшие фильмы',
    title_top_tv: 'Лучшие сериалы',
    ...
    plugins_ok_for_check: 'Нажмите (Да) для проверки плагина',
    ...
    time_from: 'из',
    time_reset: 'Сбросить временной код',
    ...
    helper_torrents_view: 'Для сброса временного кода и вызова меню удерживайте клавишу (ОК)',
    ...
    fav_clear_time_title: 'Очистить временные коды',
    fav_clear_time_descr: 'Очистить все временные коды',
    fav_label_cleared: 'Отметки очищены',
    fav_time_cleared: 'Временные коды очищены',
    ...
    player_not_found: 'Проигрыватель не найден',
    player_lauch: 'Запустить проигрыватель',
    ...
    account_premium_include_text_3: 'Не бойтесь пропустить ни одной важной сцены! Увеличьте количество временных кодов в приложении и легко отслеживайте, где остановились в просмотре любимых фильмов и сериалов.',
    ...
    extensions_hpu_screensaver: 'Заставка',
    ...
    tv_status_returning_series: 'Не завершён',
    ...
    termsofuse_t_03: 'Содержание',
    termsofuse_t_04: 'Lampa использует API (Application Programming Interface) от каталога themoviedb.org для получения информации о фильмах и телесериалах, а также для просмотра связанных с ними медиафайлов, таких как афишы, видеоролики и другое.',
    ...
    termsofuse_t_09: 'Расширения - это мощный инструмент, предоставляемый для приложения Lampa, который позволяет пользователям расширить его возможности, добавить дополнительный функционал и изменить содержание в соответствии с их потребностями.',
    ...
    termsofuse_t_13: 'Если вы считаете, что в приложении Lampa все же есть содержание, нарушающий авторские права - обратитесь к правообладателю этого содержания с просьбой удалить его со страниц сайта themoviedb.org. В свою очередь, приложение Lampa может удалить содержание при получении соответствующего уведомления о нарушении авторских прав.',
    ...
    ad_skip: 'Пропустить',
    ad_continue_after: 'Просмотр начнётся через',
    ...
    discuss_voited: 'Спасибо за вашу оценку! Ваш голос помогает улучшать содержание.'
}
