export default {
    ...
    settings_interface_animation_descr: 'Анимация карточек и содержания',
    ...
    settings_player_launch_trailers: 'проигрыватель для трейлеров',
    ...
    torrent_install_text: 'TorrServer – приложение, которое позволяет просматривать содержание из торрент-файлов в онлайн режиме.<br><br>Более детальную информацию по установке вы найдете в Telegram-группах, указанных ниже.',
